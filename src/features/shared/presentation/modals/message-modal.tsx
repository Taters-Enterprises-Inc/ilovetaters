...
export function MessageModal(props: MessageModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-start justify-center overflow-auto bg-black bg-opacity-30 backdrop-blur-sm">
      <div className="bg-paper px-4 pt-[30px] pb-3 round w-[90%] lg:w-[500px] mt-10 relative rounded-[10px]">
        <button
        ...
        <div className="flex items-center justify-end mt-3 space-x-3">
          <button
            ...
            className="py-1 w-[100px] font-bold bg-secondary text-white"
          >
            No
          </button>
          <button
            onClick={props.onYes}
            className="py-1 w-[100px] text-white bg-button font-bold"
          >
            Yes
          </button>
        </div>
