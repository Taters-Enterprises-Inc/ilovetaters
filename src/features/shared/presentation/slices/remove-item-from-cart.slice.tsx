...
export const removeItemFromCart = createAsyncThunk(
  ...
  async (param: number) => {
    const response: RemoveItemFromCartResponse =
      await RemoveItemFromCartRepository(param);
...
export const removeItemFromCartSlice = createSlice({
  ...
  extraReducers: (builder: any) => {
    builder
      .addCase(removeItemFromCart.pending, (state: any) => {
...
export const selectRemoveItemFromCart = (state: RootState) =>
