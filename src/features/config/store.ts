...
import getAdminSnackshopOrders from "features/admin/presentation/slices/get-admin-snackshop-orders.slice";
...
export const store = configureStore({
  reducer: {
    ...
    getAdminSnackshopOrders: getAdminSnackshopOrders,
  },
