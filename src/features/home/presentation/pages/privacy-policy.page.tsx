      ...
      <section className="container py-6">
        ...
        >
          ...
          <div className="space-y-4 text-secondary">
            ...
            <p>
              You can visit most pages on this website without the need of
              giving personal information; however, there are certain instances
              when we will passively collect non-personally identifiable
              information in order to give you an outstanding browsing
              experience. The information we collect and our policy regarding
              its collection and storage are discussed in detail below. We
              believe it is important for you to know how we treat and protect
              your information.
            </p>

            <p>
              The terms of this Privacy Policy apply to all users of this
              website and to all relevant activities of the Company. Should the
              Company launch other online initiatives that will require the
              collection of personal information or will entail another way of
              collecting and storing data, the Company reserves the right to
              formulate a more specific privacy policy for these initiatives.
            </p>

            <p>
              If you do not agree with the terms of this Privacy Policy, you
              should immediately stop the use of this website. Your use of this
              website shall be construed as your acknowledgment and acceptance
            ...
            <p>
              ...
              cookies, we shall declare it expressly on this website. The
              information collected, coupled with your frequent visits, will
              impact your use of the website. The collection is necessary as it
            ...
            <p>
              ...
              do not. In no way do cookies give us access to your computer or
              any information about you, other than the data you choose to share
              with us. Furthermore, any information that we gather will not be
              disclosed outside of our company, affiliates, third-party agents,
              business partners, nor will it be used for unsolicited
              communication.
            </p>

            <p>
              You do not need to enable cookies to navigate this website. If you
              prefer not to receive cookies while browsing our website, you can
              adjust your browser to alert you of the presence of cookies so
              that you may accept or refuse to accept the cookies while
              browsing. You can further adjust your browser to refuse all
              cookies that may be present on a website. By disabling or refusing
              to receive cookies, however, you may encounter some difficulties
              in using some parts of the website.
            </p>
            ...
            <p>
              We shall retain the information we collect only for as long as
              necessary for the fulfillment of the purposes stated in this
              Privacy Policy. We generally do not store this information for a
              period longer than ten years after the stated purposes have been
              fulfilled; after which, the information will be disposed of in
              accordance with the relevant data privacy laws, regulations, and
              company guidelines.
            </p>
            ...
            <p>
              Our website may contain links to other websites and landing pages
              of similar interests. Please note that we do not have any control
              over the content of these other websites. Once you leave our
              website by clicking on these links, you acknowledge that the
              Company cannot be held responsible for the protection and privacy
              of any information you provide on these other websites. We highly
              encourage you to exercise prudence and look at the privacy
              notices/policies of the other websites that you visit.
            </p>
            ...
            <p>
              ...
              <br />
              TEI CENTER 3536 Hilario Street Barangay Palanan Makati City 1230
              <br />
              tei.mis@tatersgroup.com
            </p>
          </div>
        </Tab>
      </section>
