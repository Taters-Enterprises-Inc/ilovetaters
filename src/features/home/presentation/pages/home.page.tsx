    ...
    return (
        <main className="bg-primary">
            ...
            <section 
                ...
                className="sm:hidden items-end justify-center relative ">
            ...
            <section ref={servicesRef} className="hidden sm:flex container flex-wrap pt-2 pb-[90px] lg:pb-0 justify-center items-center lg:min-h-screen content-start">
                                    ...
                                    <a href={service_desktop.url} key={i}>
                                        <div 
                                            ...
                                            <div className="w-full px-6 pt-14 pb-3 rounded-b-[1rem] lg:rounded-b-[1rem]" style={{
                                                ...
                                                <h4 className="text-[16px] sm:text-lg lg:text-2xl font-['Bebas_Neue'] ">{service_desktop.title}</h4>
            ...
            <section ref={servicesRef} className="sm:hidden container flex flex-wrap pt-2 pb-[90px] lg:pb-0 lg:justify-start justify-center items-center content-start">
