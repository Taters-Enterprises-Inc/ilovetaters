        ...
        <main className="bg-primary">
          ...
          <section className="container text-left lg:px-0 md:px-8 px-4 mx-auto pt-6 pb-16 bg-primary">
            ...
            <div className="text-white lg:pb-8 pb-10 flex-1 lg:pr-4">
              ...
              <br/>
              <p className="text-lg">
                Kindly fill up our franchise application 
                form and submit a letter of intent specifying your intended space and 
                franchise location. Send your applications thru <strong>franchising@tatersgroup.com</strong>. 
              </p>

              <div className="sm:space-x-2 sm:space-y-0 space-y-2 flex flex-col sm:flex-row mt-10 justify-center">
