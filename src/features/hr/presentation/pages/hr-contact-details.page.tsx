...
export function HrContactDetails() {
      ...
      <main className="min-h-screen text-[#242424] flex flex-col items-stretch border-b-[#F2F2F2]">
        ...
        <div className="flex flex-col overflow-y-auto h-[1500px] pt-8">
          <MaterialInput
            ...
            name="contact_number"
            defaultValue={
              getHrSessionState.data?.hr.user_contact_details?.contact_number
            }
          ...
          <MaterialInput
            ...
            name="email"
            defaultValue={
              getHrSessionState.data?.hr.user_contact_details?.email
            }
          ...
          <MaterialInput
            ...
            name="address"
            defaultValue={
              getHrSessionState.data?.hr.user_contact_details?.address
            }
            style={{ marginLeft: 30, marginRight: 30, marginTop: 15 }}
          />
          <MaterialInput
            ...
            label="City"
            name="city"
            defaultValue={getHrSessionState.data?.hr.user_contact_details?.city}
            style={{ marginLeft: 30, marginRight: 30, marginTop: 15 }}
          />
        </div>
      </main>
