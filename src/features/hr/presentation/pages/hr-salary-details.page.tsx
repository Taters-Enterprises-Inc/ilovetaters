...
export function HrSalaryDetails() {
      ...
      <main className="min-h-screen text-[#242424] flex flex-col items-stretch border-b-[#F2F2F2]">
        ...
        <div className="flex flex-col overflow-y-auto h-[1500px] pt-8">
          <MaterialInput
            ...
            name="initial_salary"
            defaultValue={getHrSessionState.data?.hr.user_salary_details?.initial_salary.toString()}
          ...
          <MaterialInput
            ...
            name="current_salary"
            defaultValue={getHrSessionState.data?.hr.user_salary_details?.current_salary.toString()}
          ...
          <MaterialInput
            ...
            name="bank_account"
            defaultValue={
              getHrSessionState.data?.hr.user_salary_details?.bank_account_no
            }
            style={{ marginLeft: 30, marginRight: 30, marginTop: 15 }}
          />
        </div>
