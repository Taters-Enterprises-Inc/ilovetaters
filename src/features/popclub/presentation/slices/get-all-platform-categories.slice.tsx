...
export const getAllPlatformCategories = createAsyncThunk('getAllPlatformCategories',
    async (param : GetAllPlatformCategoriesParam) => {
        const response : GetAllPlatformCategoriesRepositoryResponse = await GetAllPlatformCategoriesRepository(param);
...
export const getAllPlatformCategoriesSlice = createSlice({
    ...
    extraReducers: (builder: any) => {
        builder.addCase(getAllPlatformCategories.pending, (state: any)=>{
            state.status = GetAllPlatformCategoriesState.inProgress;
        }).addCase(getAllPlatformCategories.fulfilled, (state: any, action : PayloadAction<{message: string, data: Array<PlatformCategoryModel>}> ) => {
...
export const selectGetAllPlatformCategories = (state : RootState) => state.getAllPlatformCategories;
