...
export const getAllAvailableStores = createAsyncThunk('getAllAvailableStores',
...
export const getAllAvailableStoresSlice = createSlice({
    ...
    extraReducers: (builder: any) => {
        builder.addCase(getAllAvailableStores.pending, (state: any)=>{
            state.status = GetAllAvailableStoresState.inProgress;
        }).addCase(getAllAvailableStores.fulfilled, (state: any, action : PayloadAction<{message: string, data: Array<StoreModel>}> ) => {
...
export const selectGetAllAvailableStores = (state : RootState) => state.getAllAvailableStores;
