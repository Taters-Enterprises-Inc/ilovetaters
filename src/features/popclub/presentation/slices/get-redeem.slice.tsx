...
export const getRedeem = createAsyncThunk('getRedeem',
...
export const getRedeemSlice = createSlice({
    ...
    extraReducers: (builder: any) => {
        builder.addCase(getRedeem.pending, (state: any)=>{
            state.status = GetRedeemState.inProgress;
        }).addCase(getRedeem.fulfilled, (state: any, action : PayloadAction<{message: string, data: RedeemDealModel}> ) => {
