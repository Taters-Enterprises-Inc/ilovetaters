    ...
    <section className="bg-primary">
      ...
      <section className="container pt-4 flex flex-col justify-start items-start">
        {getSessionState.data?.popclub_data ? (
          ...
          >
            <span className="text-white text-lg">Claim deals via : </span>
        ...
        {getSessionState.data?.cache_data ? (
          ...
          >
            <span className="text-white text-lg">Chosen store: </span>
            <span className="text-[#ffcd17] text-lg font-['Bebas_Neue'] tracking-widest">
        ...
        <div className="overflow-y-auto w-full hide-scrollbar pl-6 font-['Bebas_Neue'] mt-2">
          <ul className="flex items-start justify-start space-x-6 mt-2 w-[400px] lg:w-full">
            <Link
              to={`?category=all`}
              className="text-gray-500 text-lg tracking-widest lg:px-2 font-semi-bold flex justify-center items-center space-x-1 "
            >
              <span
                className={
