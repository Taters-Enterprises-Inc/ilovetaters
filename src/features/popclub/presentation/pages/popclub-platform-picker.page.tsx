        ...
        <section className="hidden lg:flex container flex-wrap pt-2 pb-[90px] lg:pb-0 justify-center items-center lg:min-h-screen content-start">
          {SERVICES_DESKTOP.map(function (service_desktop, i) {
            return (
              <div
                key={i}
                className="flex-[0_0_50%] max-w-[50%] md:flex-[0_0_30%] md:max-w-[40%] lg:max-w-[30%]  lg:flex-[0_0_30%] h-[250px] sm:h-[300px] p-2 text-white"
              >
                <div
                  style={{
                    backgroundImage: `url("${
                ...
                >
                  ...
                  >
                    <h4 className="text-[16px] sm:text-lg lg:text-2xl font-bold ">
