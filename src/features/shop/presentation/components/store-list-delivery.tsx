...
export function StoreListDelivery(props: StoreListDeliveryProps ){
    ...
    return(
        <section className='text-white'>
            ...
            <div key={index}>
                <h1 className="text-sm font-normal pl-3">{store_cluster.region_name}</h1>
                <section className="flex flex-wrap pb-2">
                    {store_cluster.stores.map((store, index)=>{
                        ...
                        return (
                            <div className="p-2 max-w-[50%] flex-[0_0_50%]  sm:max-w-[33.33%] sm:flex-[0_0_33.33%] md:max-w-[25%] md:flex-[0_0_25%]">
                                <button 
                                    key={index}
