    ...
    return(
        <div className="bg-secondary lg:h-[200px] text-white pt-4">
            ...
            <div className="container py-6 flex flex-col lg:flex-row justify-between items-center bg-secondary space-y-2">
                <h1 className="text-white font-['Bebas_Neue'] tracking-[3px] text-3xl leading-8">{props.title}</h1>
                            ...
                            props.pageTitles.map((title, i)=>(
                                <li>
                                    <div className="flex items-center">
                                        ...
                                        <Link to='/shop/products' className={`${i != props.pageTitles.length - 1 ? 'text-gray-400' : 'text-white'} ml-1 text-xs lg:text-base font-medium md:ml-2 whitespace-nowrap overflow-hidden lg:max-w-full max-w-[80px] text-ellipsis`}>{title}</Link>
                                    </div>
                                </li>
                            ))
                        }
