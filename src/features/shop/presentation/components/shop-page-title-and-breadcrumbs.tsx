...
export function ShopPageTitleAndBreadCrumbs(
  props: ShopPageTitleAndBreadCrumbsProps
) {
  return (
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            <li>
              <Link
                to="/shop"
                className="inline-flex items-center text-xs lg:text-sm font-medium text-gray-400"
              >
                <svg
