      ...
      <section className="container min-h-screen lg:space-x-4 pb-36">
        <div className="lg:mt-[-80px]">
          <div className="flex flex-col items-start justify-between lg:flex-row">
            ...
            <div className="space-y-4 lg:flex-[0_0_36%] w-full lg:max-w-[36%] bg-paper  py-6 lg:px-4">
              <div className="space-y-4 lg:flex-w-full lg:max-w lg:shadow-secondary lg:shadow-md lg:rounded-[30px] py-6 lg:px-4">
