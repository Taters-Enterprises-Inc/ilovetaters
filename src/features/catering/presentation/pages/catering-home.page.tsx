...
export function CateringHome(){
    ...
    return (
        <section className="container pb-96">
            ...
            <h1 className='text-white text-lg pt-4 pb-2 font-["Bebas_Neue"] tracking-[2px]'>Thank you for considering Taters for your celebration. Kindly key in your event details.</h1>
