...
export const getStoresAvailableCatering = createAsyncThunk('getStoresAvailableCatering',
...
export const getStoresAvailableCateringSlice = createSlice({
    ...
    extraReducers: (builder: any) => {
        builder.addCase(getStoresAvailableCatering.pending, (state: any)=>{
            state.status = GetStoresAvailableCateringState.inProgress;
        }).addCase(getStoresAvailableCatering.fulfilled, (state: any, action : PayloadAction<{message: string, data: Array<StoreModel>}> ) => {
            const {data, message} = action.payload;
            state.status = GetStoresAvailableCateringState.success;
            
            state.data = data;
            state.message = message;
        }).addCase(getStoresAvailableCatering.rejected, (state: any, action: PayloadAction<{message : string}>) => {
...
export const selectGetStoresAvailableCatering = (state : RootState) => state.getStoresAvailableCatering;
