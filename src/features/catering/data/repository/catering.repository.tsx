...
export function GetCateringCategoryProductsRepository(param : GetCategoryProductsParam) : Promise<GetCategoryProductsResponse>{
    return axios.get(`${REACT_APP_DOMAIN_URL}api/catering/products${param.region_id ? '?region_id=' + param.region_id : ''}`,{
        headers: {
