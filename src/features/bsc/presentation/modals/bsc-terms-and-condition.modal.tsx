...
import { ReturnPolicyModal } from "./bsc-return-policy.modal";
    ...
    <>
      ...
      >
        <div className="md:w-[70%] w-[80%] bg-paper sm:h-[500px] h-[700px] mt-[3%] mb-[3%] add-extra-margin text-secondary">
          <Tab
            tabs={BSC_TERMS_AND_POLICY_TABS}
            activeTab="bsc-terms-and-conditions"
          >
            <Link
            ...
            <div className="lg:w-[95%] w-[90%] mx-auto lg:mt-[1%] mt-[0.5%] sm:mb-[2.5%] mb-[1.75%]">
              ...
              <div className="space-y-4 text-secondary w-[95%] mx-auto h-[425px] overflow-y-scroll terms-scroll md:text-base text-sm">
                <p>
                  {" "}
                  1. Customers can order through www.ilovetaters.com/delivery.
                </p>
                <p>
                  2. Delivery and/or pick up of items is from Mondays to
                  Saturdays between 10:00am to 5:00pm only.
                </p>
                ...
                <p>
                  5. Due to <strong>ENHANCED COMMUNITY QUARANTINE</strong> there
                  are certain areas that are in total lockdown. Any
                  falsification of delivery address is subject for CANCELLATION
                  OF ORDERS (regardless whether PAID or NOT).{" "}
                  <strong>
                    STRICTLY, NO CHANGING OF ACTUAL DELIVERY ADDRESS
                  </strong>
                  .
                </p>
                <p>
                ...
                <p>
                  ...
                  <strong>maximum of one (1) hour</strong> after placing your
                  order in the system.
                </p>
                <p>
                  8. Once payment has been made, upload the{" "}
                  <strong>payment screenshot</strong> on the link provided in
                  the order confirmation email or go to{" "}
                ...
                <p className="mb-0">
                  ...
                  <p className="mb-0 ml-[30px]">
                    <u>
                      <i> If for delivery:</i> to ask the customer the address
                      on what to pin (in Waze)
                    </u>
                  </p>
                  <p className="mb-0 ml-[30px]">
                    OR you may view the status of your order at{" "}
                    <u className="text-blue-400">www.ilovetaters.com/profile</u>{" "}
                    Just input your tracking and mobile number. Once order
                    status indicates “for dispatch” it means orders are now
                    ready for -up or delivery.
                  </p>
                </p>
                <p>
                  {" "}
                ...
                <p>
                  {" "}
                  13. No additional orders can be made during the call with the
                  sales representative.{" "}
                </p>
                <p>
                  {" "}
                  14. Taters can opt to use whether an in-house delivery or a
                  third party service to deliver the orders.{" "}
                </p>
              </div>
            </div>
          </Tab>
