...
export function CustomerSurveyPageSix() {
  const navigate = useNavigate();
  const navigateToCustomerSurveyP7 = () => {
    navigate("/survey/page-seven");
  };
  return (
    <>
      <Helmet>
        ...
        <section className=" bg-paper">
          <div className="sm:hidden">
            ...
            <div className="flex items-center justify-center pb-1 bg-paper">
              <button
                onClick={navigateToCustomerSurveyP7}
                type="submit"
